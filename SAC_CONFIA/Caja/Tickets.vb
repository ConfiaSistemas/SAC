        ...
        While reader.Read
            ...
            Select Case reader("tipo")
                ...
                Case "Terminal"
                    ...
                    Dim consultaNombre As String
                    consultaNombre = "select credito.nombre from conveniosTerminalesSac inner join credito on credito.id = conveniosTerminalesSac.idcredito where conveniosTerminalesSac.id = '" & reader("idcredito") & "'"
                    comandonombre.Connection = conexionempresa
                    comandonombre.CommandText = consultaNombre
                    nombrecredito = comandonombre.ExecuteScalar
