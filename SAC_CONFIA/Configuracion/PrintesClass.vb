...
#Region "Constructors"
    Public Sub New(ByVal AppPath As String)
        SetPrinterName("Microsoft Print to PDF", AppPath)
    End Sub
    Public Sub New(ByVal strPrinterName As String, ByVal AppPath As String, ByVal _vistaprevia As Boolean)
    ...
    Private Sub SetPrinterName(ByVal PrinterName As String, ByVal AppPath As String)
        ...
        For Each prnPrinter In Printers
            ...
            End If
        Next
        p.DocumentName = "Ticket Préstamos Confía"
        Me.Path = AppPath
        If bIsDebug Then
            If vistaprevia Then
...
#Region "Images"
    ...
    Public Sub PrintLogo()
        Me.PrintImage("C:\Program Files (x86)\MAJL\Confia\lconfiat.png")
        p.CurrentY += 500 + 100
    End Sub
...
#Region "Font"
    ...
    Public Property Copies() As Single
        Get
            Return p.Copies
        End Get
        Set(value As Single)
...
#Region "Control"
    ...
    Public Sub Gotox(ByVal x As Integer)
        p.CurrentX = x + 200
